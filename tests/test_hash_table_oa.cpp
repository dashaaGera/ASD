...
TEST(TestHashTableOpenAddress, is_empty_works_correctly) {
    HashTableOpenAddress<std::string> table(10);
...
TEST(TestHashTableOpenAddress, consist_works_correctly) {
    HashTableOpenAddress<int> table(20);
...
TEST(TestHashTableOpenAddress, erase_works_correctly) {
    HashTableOpenAddress<char> table(10);
...
TEST(TestHashTableOpenAddress, collisions_handled_correctly) {
    HashTableOpenAddress<int> table(5);
...
TEST(TestHashTableOpenAddress, exceptions_on_empty_table) {
    HashTableOpenAddress<double> table(10);
    EXPECT_TRUE(table.is_empty());
    EXPECT_EQ(table.size(), 0);
...
TEST(TestHashTableOpenAddress, func_print_work_correctly) {
    HashTableOpenAddress<std::string> table(100);
