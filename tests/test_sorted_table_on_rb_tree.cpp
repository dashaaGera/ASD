...
#include <string>
TEST(TestTableOnRBTree, is_emty_work_correctly) {
    TableOnRBTree<int, std::string> table;
...
TEST(TestTableOnRBTree, func_consist_work_correctly) {
    TableOnRBTree<int, std::string> table;
...
TEST(TestTableOnRBTree, find_work_corretly) {
    TableOnRBTree<int, std::string> table;
    ...
    TableOnRBTree<int, double> table1;
    table1.insert(1, 1.1);
    table1.insert(2, 2.2);
...
TEST(TestTableOnRBTree, erase_work_corretly) {
    TableOnRBTree<int, std::string> table;
...
TEST(TestTableOnRBTree, func_print_work_corretly) {
    TableOnRBTree<int, std::string> table;
    table.insert(5, "five");
    table.insert(2, "two");
