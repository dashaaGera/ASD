...
TEST(TestSortedTableOnVec, is_emty_work_correctly) {
...
TEST(TestSortedTableOnVec, func_consist_work_correctly) {
    SortedTableOnVec<int, std::string> table;
...
TEST(TestSortedTableOnVec, find_work_corretly) {
    SortedTableOnVec<int, std::string> table;
    ...
    SortedTableOnVec<int, double> table1;
    table1.insert(1, 1.1);
    table1.insert(2, 2.2);
...
TEST(TestSortedTableOnVec, erase_work_corretly) {
    SortedTableOnVec<int, std::string> table;
