...
TEST(TestLexemSequence, after_�onstant_correct_sequences) {
...
TEST(TestLexemSequence, after_�onstant_no_correct_sequences) {
...
TEST(TestLexemSequence, after_�lose_bracket_correct_sequences) {
...
TEST(TestLexemSequence, after_�lose_bracket_no_correct_sequences) {
